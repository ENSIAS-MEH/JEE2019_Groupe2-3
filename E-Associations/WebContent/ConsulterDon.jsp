			...
			<div>
				...
				<div class="row clearfix">
					...
					<ul class="row2tab clearfix">
					    ...
					    <li  role="presentation"><a  href="ProfileAssociation.jsp" >Acceuil</a></li>
						<li  href="MesEvenements.jsp"><i class="fa fa-list-alt" ></i> Mes Evenements </li>
						<li href = "ModifierProfile.jsp"><i class="fa fa-heart"></i></li>
						<li  href = "AjouterEvenement.jsp"><i class="fa fa-check"></i> Ajouter un evenement </li>
						<li href = "ConsulterDon" ><i class="fa fa-thumbs-o-up "></i>Consulter mes dons </li>
