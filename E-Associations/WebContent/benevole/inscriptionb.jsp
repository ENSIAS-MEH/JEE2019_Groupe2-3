...
<div class="tr">
  ...
  <label class="label" for="input">Numero</label>	
	<input class="input e" type="text" id="input" name = "tele_ben">
      </div>
       <div class="social r1">
  <label class="label" for="input">Profession </label>	
	<input class="input e" type="text" id="input" name = "profession_ben">
</div>
         <div class="social r2">
  <label class="label" for="input">Email</label>	
	<input class="input e" type="text" id="input" name = "email_ben">
      </div> 
  ...
  <label class="label" for="input">Mot de passe</label>	
	<input class="input e" type="password" id="input" name ="mdp_login">
      ...
      <button value="change_password" name="savebenevole" value="savebenevole" >S'inscrire</button>
