     ...
     <ul class="ul">
	  ...
	  <h3 style="text-align: center;">Participer à un projet</h3>
	  	...
	  	<!-- Section nombre de participations -->
	  		...
	  		<b><a href="/E-Associations/participations.do">Retourner à la page précédente pour rechercher un autre projet</a></b>
	  		<br>
	  		<p><h4>Visualisation du projet recherché:</h4></p>
	  		<p>
	  			...
	  			<table id="table1">
 					...
 					<th>Description</th>
  					...
  					<%for(int i=0;i<listePj.size();i++){ 
  					  pm = listePj.get(i);
  					  String recupererTitre = (String)session.getAttribute("recupererTitre");
  					  if(recupererTitre.equals(pm.getNom_projet())){
  					  %>
  						<tr>
